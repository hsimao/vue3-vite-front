<template>
  <div class="sticky top-0 left-0 z-10 w-full bg-white dark:bg-zinc-800">
    ...
    >
      <!-- 展示箭頭 -->
      <div
        class="cursor-pinter absolute right-1 bottom-1 z-20 cursor-pointer rounded p-1 duration-200 hover:bg-zinc-200 dark:hover:bg-zinc-900"
      ...
      <li
        ...
        :key="item.id"
        class="z-10 mr-1 mb-1 h-4 shrink-0 cursor-pointer rounded px-1.5 py-0 text-base font-bold leading-4 text-zinc-900 duration-200 hover:bg-zinc-200 dark:text-zinc-500 dark:hover:bg-zinc-900 dark:hover:text-zinc-300"
        :class="{
